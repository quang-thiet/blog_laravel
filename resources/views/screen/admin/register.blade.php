...
<html lang="en">
	...
	<head>
		...
		<link href="/admin-assets/css/pages/login/classic/login-5.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
				...
				<div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(/admin-assets/media/bg/bg-2.jpg);">
					<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
						...
						<div class="d-flex flex-center mb-15">
							<a href="#">
								<img src="/admin-assets/media/logos/logo-letter-13.png" class="max-h-75px" alt="" />
							</a>
						</div>
						<!--end::Login Header-->
						...
						<div class="login-signin">
							...
							@endif
							<form class="form" method="POST" action="{{ route('processRegister') }}" id="kt_login_signin_form">
								@csrf
								<div class="form-group">
									<input value="{{ old('name') }}" class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="text" placeholder="Name" name="name" autocomplete="off" />
									@error('name')
								...
								<div class="form-group">
									<input value="{{ old('password') }}" class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="password" placeholder="Password" name="password" />
									@error('password')
									<p class="text-danger">{{ $message }}</p>	
									@enderror
								</div>
								...
								<div class="form-group">
									<input value="{{ old('password-2') }}" class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="password" placeholder="Password" name="password-2" />
									@error('password-2')
									<p class="text-danger">{{ $message }}</p>	
									@enderror
								</div>
								...
								<div class="form-group text-center mt-10">
									<button id="kt_login_signin_submit" class="btn btn-pill btn-primary opacity-90 px-15 py-3">Register</button>
								</div>
							</form>
							<div class="mt-10">
								<span class="opacity-40 mr-4">Don't have an account yet?</span>
								<a href="javascript:;" id="kt_login_signup" class="text-white opacity-30 font-weight-normal">Register</a>
							</div>
						</div>
						...
						<div class="login-signup">
							...
							<form class="form text-center" action="{{ route('processRegister') }}" method="POST" id="kt_login_signup_form">
								<div class="form-group">
		...
		{{-- <script src="/admin-assets/js/pages/custom/login/login-general.js"></script> --}}
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>
...
@section('title-heading', 'thông tin user')

@section('content')
<form id="add-product" method="POST" action="{{ route('user.process.update',Auth::id()) }}" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-md-8">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $user->name }}" name="name" placeholder="Nhập tiêu đề bài viết">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-inline">
                          ...
                          @else
                          <label class="radio radio-rounded">
                            <input type="hide" value="0" name="role" @checked($user->role == 0)>
                            <span></span>user</label>
                          @endif
                        </div>
                    </div>
        ...
        <div class="card-footer">
            ...
            <a href="{{ route('user.list') }}"><button type="button" class="btn btn-success mr-2">Danh sách bài viết</button></a>
        </div>
    </div>
</form>
@endsection

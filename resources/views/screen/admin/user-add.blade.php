...
@section('content')
<form id="add-user" method="POST" action="{{ route('user.process.add') }}" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-md-8">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="" name="name" placeholder="Nhập name user">
                        @error('name')
                    ...
                    <div class="form-group">
                        <label>password
                            <span class="text-danger">*</span></label>
                            <input name="password" rows="4" class="form-control" placeholder="Nhập password" value=""></input>
                            @error('password')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                    </div>
